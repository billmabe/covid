...
(c) test each of the three files for whether their values for Confirmed, Deaths, and Recovered are cumulative totls or daily totals.
...
```{r}
write.csv(county_data, file = "~/Documents/GitHub/covid/country_data.csv", row.names = FALSE)
